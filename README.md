...
However, You might already have a shell preference, if that's the case
use you're own shell preference, and to match the wezterm config you can 
just set the `font` and `background color` variables the same.
...
- Optimized border layouts for clean, rounded geometry tracking.
